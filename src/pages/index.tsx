  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Meu nome é Rodrigo e sou um desenvolvedor de software com vasta experiência em resolver problemas complexos e entregar soluções de qualidade. Ao longo de minha carreira, desenvolvi habilidades técnicas que me permitem trabalhar em diferentes plataformas e linguagens de programação, como PHP e JavaScript.
...
<section className={styles.section1}>
 ...
 <img src="./banner.png" width={'29%'} alt="ilustração de um programador" />
</span>
 
</section>


<section className={styles.section2} data-aos="zoom-in" id='stacks'  data-aos-duration="1000">
  <h1>Stack</h1>
<br /><br />
  <ul>
    <li>
...
<section className={styles.section4} data-aos="zoom-in" id='sobre'  data-aos-duration="1000">
<h1>Sobre min</h1>
<br />
<br />
<span>
<img src="/profile.png" width={'100px'} height={"100px"} style={{borderRadius: "50%"}} alt="" />
</span>
<br />
...
<br />
<br />
<section className={styles.section5} data-aos="zoom-in" id='curriculo'  data-aos-duration="1000">
...
Em resumo, o projeto que desenvolvi é uma solução completa e profissional para o gerenciamento de equipes de técnicos em uma empresa de telecomunicações. Com a implementação de funcionalidades avançadas de autenticação, autorização e atualização em tempo real, além de medidas de segurança e infraestrutura robustas, é possível garantir uma maior eficiência e segurança no gerenciamento das atividades e equipes da empresa.
  ...
  <figure>
            <img src="./mapa-de-area.gif"  alt='projeto mapeamento de técnicos por cidade'/>
      </figure>
